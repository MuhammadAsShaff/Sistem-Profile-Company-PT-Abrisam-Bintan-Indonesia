<div class="container mx-auto px-4 sm:px-6 lg:px-14 py-8 ">
  <div class="p-6 sm:p-8 rounded-bl-[3rem] rounded-tr-[3rem] shadow-lg relative bg-gradient-to-r from-[#CD0A45] to-[#FD2B77]">
    <!-- Gambar latar belakang -->
    <div class="absolute inset-0 bg-no-repeat bg-right bg-contain opacity-90"
