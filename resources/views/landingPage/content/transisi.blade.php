<div class="container mx-auto px-4 sm:px-6 lg:px-2 py-8 ">
  <div class="p-6 sm:p-8 rounded-bl-[3rem] rounded-tr-[3rem] shadow-lg relative bg-gradient-to-r from-[#D10A3C] to-[#FF0038]">
    <!-- Gambar latar belakang -->
    <div class="absolute inset-0 bg-no-repeat bg-right bg-contain opacity-100"
      style="background-image: url('/images/indihome-maps-banner.png');"></div>
