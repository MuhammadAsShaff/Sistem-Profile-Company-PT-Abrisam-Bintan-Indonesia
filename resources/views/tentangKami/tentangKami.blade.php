@if ($tentangKami)
  ...
  <div class="rounded-lg mb-4 "> <!-- Menambahkan padding untuk header -->
    ...
    <p class="mt-2 text-gray-600 text-justify md:text-left"> <!-- Justify untuk mobile, rata kiri untuk desktop -->
  ...
  <div class="flex flex-col md:flex-row items-center gap-10 mt-8">
    ...
    <p class="text-gray-600 leading-relaxed text-justify md:text-left"> <!-- Justify untuk mobile, rata kiri untuk desktop -->
    {{$tentangKami->visi}}
    </p>
    </div>
