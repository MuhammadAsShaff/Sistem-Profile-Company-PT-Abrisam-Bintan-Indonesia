...
<button type="button" onclick="openModal('popup-modal-{{ $admin->id }}')"
...
<dialog id="popup-modal-{{ $admin->id }}" class="modal rounded-lg shadow-lg modal-hide"
  style=" transform: translate(-50%, -50%);">
  <div class="relative bg-white rounded-xl shadow dark:bg-gray-700 p-4 md:p-5 text-center">

    <!-- Close button -->
    <button type="button" onclick="closeModal('popup-modal-{{ $admin->id }}')"
    ...
    <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Apakah Anda yakin ingin menghapus pengguna
      ini?</h3>
