<form method="GET" action="{{ route('dashboard.Promo.Promo') }}" class="max-w-lg mx-auto">
  <div class="flex">
    ...
    <div class="relative w-full">
      ...
      <!-- Search Button -->
      <button type="submit"
        class="absolute top-0 right-0 p-2.5 text-sm font-medium h-full text-white bg-red-500 rounded-lg border border-red-600 hover:bg-red-600 focus:ring-4 focus:outline-none focus:ring-red-300 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800">
      ...
      @if(request('search'))
      <a href="{{ route('dashboard.Promo.Promo') }}"
