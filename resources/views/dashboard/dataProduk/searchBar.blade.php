<form method="GET" action="{{ route('dashboard.dataProduk.dataProduk') }}" class="max-w-lg mx-auto">
  <div class="flex">
    <!-- Tombol Dropdown untuk Kategori -->
    ...
    <!-- Daftar Dropdown untuk Kategori -->
