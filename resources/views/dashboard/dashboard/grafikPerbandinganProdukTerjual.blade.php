<h2 class="mt-8 mb-2 text-xl font-bold">Grafik Perbandingan Produk Terjual</h2>
<div class="w-full bg-white rounded-lg shadow-md mb-8 shadow dark:bg-gray-800 p-4 md:p-6 flex flex-col justify-between">
