<div class="max-w-2xl w-full bg-white rounded-lg mt-8 mb-8 shadow dark:bg-gray-800 p-4 md:p-6 flex flex-col justify-between">
  ...
  <div id="data-series-chart" class="flex-grow mt-4" style="height: 220px;"></div>
