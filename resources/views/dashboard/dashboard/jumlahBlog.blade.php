<a href="{{route('dashboard.blog.blog')}}" class="block w-full h-full p-4 border border-gray-200 rounded-lg shadow bg-white flex items-center space-x-4 min-h-[120px]">
  <!-- Ikon -->
