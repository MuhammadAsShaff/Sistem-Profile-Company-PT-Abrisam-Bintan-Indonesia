<h2 class="mt-8 mb-2 text-xl font-bold">Grafik Customer Perbulan</h2>
<div class="w-full bg-white rounded-lg shadow-md shadow mb-8 p-4 md:p-6 flex flex-col justify-between">
