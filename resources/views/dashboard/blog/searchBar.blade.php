<form method="GET" action="{{ route('dashboard.blog.blog') }}" class="max-w-lg mx-auto">
  <div class="flex">
    ...
    <button id="dropdown-button" data-dropdown-toggle="dropdown"
      ...
      type="button">
      {{ request('kategori') ? request('kategori') : 'Semua Kategori' }}
    ...
    <div class="relative w-full">
      ...
      @if(request('search'))
      <a href="{{ route('dashboard.blog.blog') }}"
