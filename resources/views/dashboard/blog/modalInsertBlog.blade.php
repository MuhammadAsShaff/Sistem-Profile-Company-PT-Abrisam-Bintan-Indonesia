        ...
        <div class="flex items-start gap-6">
          ...
          <div class="flex flex-col items-center justify-center">
            <label for="dropzone-file" class="block text-sm font-medium text-gray-700 mt-3">Unggah Gambar
              blog</label>
            <input id="dropzone-file" type="file" name="gambar_blog" accept="image/png, image/jpeg, image/jpg"
              class="mt-32 ml-10">
          </div>

          <!-- Nama dan Deskripsi blog -->
          <div class="flex-1">
            <p class="mb-4 text-sm text-gray-500" style="word-wrap: break-word; white-space: normal;">
              Anda dapat menambahkan data blog baru dengan nama, <br>deskripsi, dan gambar. Pastikan untuk
              memasukkan
            ...
            <div class="mb-4">
              ...
              <input type="text" name="nama_blog" id="nama_blog"
            ...
            <div class="mb-4">
              ...
              <textarea name="deskripsi" id="deskripsi" rows="3"
                class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-[85%] p-2.5"
                placeholder="Deskripsi blog" required></textarea>
            </div>
