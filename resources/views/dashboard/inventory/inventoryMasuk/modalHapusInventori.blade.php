...
<button type="button" onclick="openModal('popup-modal-{{ $item->id_inventoryMasuk }}')"
...
<dialog id="popup-modal-{{ $item->id_inventoryMasuk }}" class="modal rounded-lg shadow-lg modal-hide"
  style="transform: translate(-50%, -50%);">
  <div class="relative bg-white rounded-xl shadow dark:bg-gray-700 p-4 md:p-5 text-center">

    <!-- Close button -->
    <button type="button" onclick="closeModal('popup-modal-{{ $item->id_inventoryMasuk }}')"
    ...
    <form action="{{ route('inventory.delete', $item->id_inventoryMasuk) }}" method="POST" class="inline">
      @csrf
      @method('DELETE')
      <button type="submit"
