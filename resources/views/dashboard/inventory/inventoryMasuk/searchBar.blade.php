<form method="GET" action="{{ route('dashboard.FaQ.FaQ') }}" class="max-w-lg mx-auto">
  <div class="flex">
    <!-- Dropdown Filter for FaQ -->
    <button id="dropdown-button" data-dropdown-toggle="dropdown"
      ...
      type="button">
      {{ request('filter') ? request('filter') : 'Semua FaQ' }}
    ...
    <div class="relative w-full">
      ...
      @if(request('search'))
      <a href="{{ route('dashboard.FaQ.FaQ  ') }}"
