...
<button id="openModalButton" onclick="openModal('updateInventoryKeluarModal-{{ $item->id_inventoryKeluar }}')"
...
<!-- Modal -->
<dialog id="updateInventoryKeluarModal-{{ $item->id_inventoryKeluar }}"
  ...
  <div class="relative bg-white rounded-lg shadow-lg p-6">
    ...
    <div class="relative bg-white rounded-lg">
      ...
      <div class="flex items-start justify-between p-5 border-b border-gray-200 rounded-t mb-4">
        <h3 class="text-lg font-semibold text-gray-900">Update Inventori Keluar</h3>
        <button id="closeModalButton" type="button"
          class="text-gray-400 hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 inline-flex items-center"
          onclick="closeModal('updateInventoryKeluarModal-{{ $item->id_inventoryKeluar }}')">
      ...
      <!-- Modal body -->
      <form action="{{ route('inventoryKeluar.update', $item->id_inventoryKeluar) }}" method="POST"
        ...
        <div class="flex items-start gap-6">
          ...
          <div class="flex-1">
            <p class="mb-4 text-sm text-gray-500" style="word-wrap: break-word; white-space: normal;">
              Anda dapat memperbarui informasi inventori keluar ini dengan kategori produk yang relevan.<br> Pastikan
        ...
        <div class="flex justify-end p-4 border-t border-gray-200">
          <button type="submit"
            ...
            Update Inventori Keluar & Terkait
          </button>
        </div>
      </form>
    </div>
