  ...
  <div class="flex flex-col justify-between flex-1 mt-6">
    <nav>
      ...
      <a class="flex items-center px-4 py-2 mb-4 text-gray-600 rounded-lg transition-colors duration-300 {{ Request::is('dashboard.FaQ.FaQ') ? 'bg-gray-100 border-l-4 border-red-500 text-blue-600' : 'hover:bg-gray-100 hover:text-gray-700' }}"
       ...
       <!-- Data Tentang Kami -->
      <a class="flex items-center px-4 py-2 mb-4 text-gray-600 rounded-lg transition-colors duration-300 {{ Request::is('dashboard.tentangKami.layoutTentangKami') ? 'bg-gray-100 border-l-4 border-red-500 text-blue-600' : 'hover:bg-gray-100 hover:text-gray-700' }}"
        ...
        <span class="mx-4 font-medium">Tentang Kami</span>
      </a>
