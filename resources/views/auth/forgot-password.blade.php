    ...
    <div class="container mx-auto max-w-4xl px-4 flex justify-center">
      <ol class="flex items-center space-x-4 rtl:space-x-reverse">
        <li class="flex items-center text-red-500 dark:text-red-400 space-x-2 rtl:space-x-reverse">
          ...
          <span>
            <h3 class="font-bold font-telkomsel leading-tight text-red-500 dark:text-red-400">Masukkan Email</h3>
    ...
    <div class="container flex flex-col items-center justify-center px-6 mx-auto space-y-8">
      ...
      <div class="w-full max-w-md mx-auto">
        <form method="POST" action="{{ route('password.email') }}" class="space-y-6">
          @csrf
          <div>
            <label for="default-email" class="block mb-2 text-sm font-medium font-telkomsel text-gray-600 dark:text-gray-200">Email:</label>
            <div class="relative">
          ...
          <!-- Tombol Kirim -->
          <button type="submit" class="w-full px-6 py-3 text-sm font-medium font-telkomsel tracking-wide text-white capitalize transition-colors duration-300 transform bg-red-500 rounded-lg hover:bg-red-400 focus:outline-none focus:ring focus:ring-red-300 focus:ring-opacity-50">
            Kirim Link Reset
          </button>
